  ...
  Widget build(BuildContext context) {
    ...
    Container(
      ...
      child: SizedBox(
        width: 1080,
        child: Container(
          padding: EdgeInsets.fromLTRB(50, 332, 0, 50),
          child: Column(
            mainAxisAlignment: MainAxisAlignment.start,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Container(
                margin: EdgeInsets.fromLTRB(275, 0, 0, 406),
                child: Align(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        padding: EdgeInsets.fromLTRB(20, 11, 0, 0),
                        child: Stack(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Container(
                                  margin: EdgeInsets.fromLTRB(0, 13, 22, 0),
                                  child: ImageFiltered(
