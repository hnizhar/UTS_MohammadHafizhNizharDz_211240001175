    ...
    Container(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Container(
              margin: EdgeInsets.fromLTRB(0, 70, 0, 73),
              child: SizedBox(
                width: 192,
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      margin: EdgeInsets.fromLTRB(2.5, 0, 0, 36),
                      child: SizedBox(
                        width: 80.5,
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    ...
                    Container(
                      margin: EdgeInsets.fromLTRB(9.2, 0, 0, 35),
                      child: SizedBox(
                        width: 89.2,
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    ...
                    Container(
                      margin: EdgeInsets.fromLTRB(31.7, 0, 0, 34),
                      child: SizedBox(
                        width: 109.7,
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    ...
                    Container(
                      margin: EdgeInsets.fromLTRB(17.3, 0, 17.3, 32),
                      child: Align(
                        alignment: Alignment.topRight,
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.start,
                    ...
                    Container(
                      margin: EdgeInsets.fromLTRB(16.7, 0, 0, 32),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                    ...
                    Container(
                      margin: EdgeInsets.fromLTRB(6.4, 0, 0, 37),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                    ...
                    Container(
                      margin: EdgeInsets.fromLTRB(0, 0, 10.7, 36),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
            ...
            Container(
              ...
              child: SizedBox(
                width: 319.6,
                child: Container(
                  padding: EdgeInsets.fromLTRB(17.1, 20.5, 15.7, 3.7),
                  child: Stack(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              margin: EdgeInsets.fromLTRB(0, 0, 1.3, 20.2),
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Container(
                                              margin: EdgeInsets.fromLTRB(0, 0, 16.4, 6.8),
                                              child: Text(
                                                'Location',
                                                style: GoogleFonts.getFont(
                                                  'Raleway',
                                      ...
                                      Container(
                                        margin: EdgeInsets.fromLTRB(0, 27.4, 0, 6.2),
                                        width: 8.6,
                                        height: 5.2,
                                        child: SizedBox(
                                          width: 8.6,
                                  ...
                                  Container(
                                    margin: EdgeInsets.fromLTRB(0, 6.7, 0, 11.7),
                                    child: SizedBox(
                                      width: 20.5,
                                      height: 20.5,
                                      child: SvgPicture.asset(
                            ...
                            Container(
                              margin: EdgeInsets.fromLTRB(0, 0, 0, 73.6),
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Expanded(
                                    child: Container(
                                      ...
                                      child: Container(
                                        ...
                                        child: Container(
                                          padding: EdgeInsets.fromLTRB(17.6, 13.7, 0, 13.7),
                                          child: Row(
                                            mainAxisAlignment: MainAxisAlignment.start,
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                  ...
                                  Container(
                                    ...
                                    child: Container(
                                      width: 41.1,
                                      height: 41.1,
                                      padding: EdgeInsets.fromLTRB(13.7, 13.7, 13.7, 13.7),
                                      child: SizedBox(
                                        width: 13.7,
                                        height: 13.7,
                                        child: SvgPicture.asset(
                            ...
                            Container(
                              margin: EdgeInsets.fromLTRB(0, 0, 20.5, 10.2),
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Container(
                                    margin: EdgeInsets.fromLTRB(0, 0, 8, 10.6),
                                    child: SizedBox(
                                      width: 232.5,
                                      child: Text(
                                        'Near from you',
                            ...
                            Container(
                              margin: EdgeInsets.fromLTRB(0, 0, 0, 27.4),
                              child: Align(
                                ...
                                child: Container(
                                  ...
                                  child: Container(
                                    padding: EdgeInsets.fromLTRB(17.1, 17.1, 13.7, 13.7),
                                    child: Column(
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                          ...
                                          child: Align(
                                            ...
                                            child: Container(
                                              ...
                                              child: SizedBox(
                                                ...
                                                height: 20.5,
                                                child: Container(
                                                  padding: EdgeInsets.fromLTRB(9.4, 5.1, 9.4, 5.1),
                                                  child: Stack(
                                                    clipBehavior: Clip.none,
                                                    children: [
                                                      Container(
                            ...
                            Container(
                              margin: EdgeInsets.fromLTRB(0, 0, 20.5, 9.4),
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Container(
                                    margin: EdgeInsets.fromLTRB(0, 0, 8, 11.4),
                                    child: SizedBox(
                                      width: 232.5,
                                      child: Text(
                                        'Best for you',
                            ...
                            Container(
                              ...
                              child: Align(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                      margin: EdgeInsets.fromLTRB(0, 0, 17.1, 19.7),
                                      decoration: BoxDecoration(
                                        borderRadius: BorderRadius.circular(8.6),
                                      ...
                                      child: Container(
                                        ...
                                        child: Container(
                                          ...
                                          height: 59.9,
                                          decoration: BoxDecoration(
                                            borderRadius: BorderRadius.circular(8.5600214005),
                                          ),
                                          child: Positioned(
                                            right: -20.5,
                                            bottom: -3.4,
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Container(
                                          margin: EdgeInsets.fromLTRB(3.4, 0, 3.4, 7.1),
                                          child: Align(
                                            alignment: Alignment.topLeft,
                                            child: Text(
                                              'Orchad House',
                                        ...
                                        Container(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Container(
                                                margin: EdgeInsets.fromLTRB(0, 0.9, 19, 24),
                                                child: Row(
                                                  mainAxisAlignment: MainAxisAlignment.start,
                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                  children: [
                                                    Container(
                                                      margin: EdgeInsets.fromLTRB(0, 0.9, 10.3, 0.2),
                                                      width: 13.7,
                                                      height: 11,
                                                      child: SizedBox(
                                                        width: 13.7,
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  Container(
                                                    margin: EdgeInsets.fromLTRB(0, 0, 10.3, 23.6),
                                                    width: 13.7,
                                                    height: 13.2,
                                                    child: SizedBox(
                                                      width: 13.7,
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Container(
                                              margin: EdgeInsets.fromLTRB(0, 0.9, 19.6, 24),
                                              child: Row(
                                                mainAxisAlignment: MainAxisAlignment.start,
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                      ...
                      Positioned(
                        ...
                        child: SizedBox(
                          ...
                          height: 35.1,
                          child: Container(
                            padding: EdgeInsets.fromLTRB(0, 1.7, 0, 4.3),
                            child: Stack(
                              clipBehavior: Clip.none,
                              children: [
                                Positioned(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Container(
                                          ...
                                          child: Container(
                                            padding: EdgeInsets.fromLTRB(13.7, 8.6, 13.6, 8.5),
                                            child: Text(
                                              'House',
                                              style: GoogleFonts.getFont(
                                                'Raleway',
                                      ...
                                      Expanded(
                                        child: Container(
                                          ...
                                          child: Container(
                                            ...
                                            child: Container(
                                              padding: EdgeInsets.fromLTRB(13.7, 8.6, 12.9, 8.5),
                                              child: Text(
                                                'Apartment',
                                                style: GoogleFonts.getFont(
                                                  'Raleway',
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: SizedBox(
                            ...
                            height: 232.8,
                            child: Container(
                              padding: EdgeInsets.fromLTRB(17.1, 17.1, 12, 1.7),
                              child: Column(
                                mainAxisAlignment: MainAxisAlignment.start,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                              ...
                              SizedBox(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      margin: EdgeInsets.fromLTRB(0, 0, 23.7, 47.7),
                                      child: Text(
                                        'Sea Breezes House',
                                        style: GoogleFonts.getFont(
                                          'Raleway',
                                    ...
                                    Expanded(
                                      child: Container(
                                        margin: EdgeInsets.fromLTRB(0, 42.8, 0, 0),
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.start,
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                              ...
                              Positioned(
                                ...
                                child: SizedBox(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        margin: EdgeInsets.fromLTRB(0, 0.9, 10.3, 24.2),
                                        width: 13.7,
                                        height: 11,
                                        child: SizedBox(
                                          width: 13.7,
                              ...
                              SizedBox(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      margin: EdgeInsets.fromLTRB(0, 0, 25.6, 47.7),
                                      child: Text(
                                        'Little Copse House',
                                        style: GoogleFonts.getFont(
                                          'Raleway',
