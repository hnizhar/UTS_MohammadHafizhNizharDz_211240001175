            ...
            SizedBox(
              ...
              child: Column(
                ...
                children: [
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      margin: EdgeInsets.fromLTRB(0, 10, 0, 6.9),
                                      width: 10,
                                      height: 6.1,
                                      child: SizedBox(
                                        width: 10,
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(2, 0, 2, 18),
                    child: Align(
                      alignment: Alignment.topLeft,
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                          ...
                          Container(
                            ...
                            child: Container(
                              ...
                              child: SizedBox(
                                width: 279,
                                child: Container(
                                  padding: EdgeInsets.fromLTRB(20.6, 16, 0, 16),
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.start,
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Container(
                                    padding: EdgeInsets.fromLTRB(16, 10, 16.7, 10),
                                    child: Text(
                                      'Apartment',
                                      style: GoogleFonts.getFont(
                                        'Raleway',
                                ...
                                Container(
                                  ...
                                  child: Container(
                                    padding: EdgeInsets.fromLTRB(16, 10, 17, 10),
                                    child: Text(
                                      'Hotel',
                                      style: GoogleFonts.getFont(
                                        'Raleway',
                                ...
                                Container(
                                  ...
                                  child: Container(
                                    padding: EdgeInsets.fromLTRB(16, 10, 16.2, 10),
                                    child: Text(
                                      'Villa',
                                      style: GoogleFonts.getFont(
                                        'Raleway',
                                    ...
                                    Container(
                                      ...
                                      child: Align(
                                        ...
                                        child: Container(
                                          ...
                                          child: Container(
                                            padding: EdgeInsets.fromLTRB(11, 5, 10, 5),
                                            child: Row(
                                              mainAxisAlignment: MainAxisAlignment.start,
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                Container(
                                                  margin: EdgeInsets.fromLTRB(0, 1, 7, 1),
                                                  width: 10,
                                                  height: 12,
                                                  child: SizedBox(
                                                    width: 10,
                                  ...
                                  Container(
                                    ...
                                    child: Align(
                                      ...
                                      child: Container(
                                        ...
                                        child: Container(
                                          padding: EdgeInsets.fromLTRB(11, 5, 10.5, 5),
                                          child: Row(
                                            mainAxisAlignment: MainAxisAlignment.start,
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                ...
                                Container(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Container(
                                          margin: EdgeInsets.fromLTRB(0, 1, 0, 0.4),
                                          child: Row(
                                            mainAxisAlignment: MainAxisAlignment.start,
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              Container(
                                                margin: EdgeInsets.fromLTRB(0, 1, 12, 0.2),
                                                width: 16,
                                                height: 12.8,
                                                child: SizedBox(
                                                  width: 16,
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              Container(
                                margin: EdgeInsets.fromLTRB(0, 0, 25.4, 5),
                                child: Column(
                                  mainAxisAlignment: MainAxisAlignment.start,
                                  crossAxisAlignment: CrossAxisAlignment.center,
                                  children: [
                                    Container(
                                      margin: EdgeInsets.fromLTRB(0, 0, 1.1, 13),
                                      child: Text(
                                        'Sea Breezes House',
                                        style: GoogleFonts.getFont(
                                          'Raleway',
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Container(
                                            margin: EdgeInsets.fromLTRB(0, 1, 12.1, 0.2),
                                            width: 16.1,
                                            height: 12.8,
                                            child: SizedBox(
                                              width: 16.1,
                              ...
                              Container(
                                margin: EdgeInsets.fromLTRB(0, 50, 0, 4.6),
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.start,
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              Container(
                                margin: EdgeInsets.fromLTRB(0, 0, 24.6, 5),
                                child: Column(
                                  mainAxisAlignment: MainAxisAlignment.start,
                                  crossAxisAlignment: CrossAxisAlignment.center,
                                  children: [
                                    Container(
                                      margin: EdgeInsets.fromLTRB(0, 0, 3.3, 13),
                                      child: Text(
                                        'Little Copse House',
                                        style: GoogleFonts.getFont(
                                          'Raleway',
