      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              margin: EdgeInsets.fromLTRB(20, 0, 20.1, 24),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.start,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
            ...
            Container(
              margin: EdgeInsets.fromLTRB(20, 0, 24, 32),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
            ...
            Container(
              margin: EdgeInsets.fromLTRB(20, 0, 19, 32),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.start,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: Container(
                            padding: EdgeInsets.fromLTRB(0, 25, 0.7, 24),
                            child: Text(
                              '+5',
                              style: GoogleFonts.getFont(
                                'Raleway',
            ...
            Stack(
              children: [
                ...
                Container(
                          width: 335,
                          height: 150,
                          padding: EdgeInsets.fromLTRB(153.1, 49.9, 0, 92.8),
                          child: Container(
                            decoration: BoxDecoration(
                              color: Color(0xFF0A8ED9),
                          ...
                          SizedBox(
                            ...
                            child: Row(
                              ...
                              children: [
                                Expanded(
                                  child: Container(
                                    margin: EdgeInsets.fromLTRB(0, 1, 28.9, 1),
                                    child: Column(
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
